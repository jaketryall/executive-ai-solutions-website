...
export const INDUSTRIES: IndustryPack[] = [
  {
    ...
    demo: {
      ...
      about: "We were founded by instructors who never lost the love of teaching it. Small classes, aircraft that are washed and maintained like they're ours — because they are — and a pass rate we'd put on a billboard.",
  ...
  },
  {
    ...
    demo: {
      ...
      about: "Every business says quality and service. The ones that win show it — with a site that looks like the work costs what it costs, answers questions before they're asked, and makes getting in touch the easiest thing on the page.",
