...
function DesktopContact() {
  ...
  return (
    <section ref={sectionRef} id="contact-desktop" data-seam-enter="seam-4" data-seam-exit="seam-5" className="hidden md:block py-32 px-6" style={{ backgroundColor: "#0a0908", color: "#e5e1db" }}>
